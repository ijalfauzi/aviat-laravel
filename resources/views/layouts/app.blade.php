...
<head>
    ...
    <meta name="description" content="Sistem Informasi dan Aset Manajemen Rumah Sakit Online dan Layanan Kesehatan. Penerapan SIMRS, SAMRS, Sistem Rekam Medis, Aviat Mobile App.">
    <title>@yield('title')</title>
    <link rel="apple-touch-icon" href="/assets/images/aviat.webp">
    <link rel="shortcut icon" type="image/x-icon" href="/assets/images/aviat.webp">
    <link href="https://fonts.googleapis.com/css?family=Rubik:300,400,500,600%7CIBM+Plex+Sans:300,400,500,600,700" rel="stylesheet">

    <!-- BEGIN: Vendor CSS-->
    <link rel="stylesheet" type="text/css" href="/frest/app-assets/vendors/css/vendors.min.css">
    <link rel="stylesheet" type="text/css" href="/frest/app-assets/vendors/css/charts/apexcharts.css">
    <link rel="stylesheet" type="text/css" href="/frest/app-assets/vendors/css/extensions/dragula.min.css">
    <!-- END: Vendor CSS-->

    <!-- BEGIN: Theme CSS-->
    <link rel="stylesheet" type="text/css" href="/frest/app-assets/css/bootstrap.css">
    <link rel="stylesheet" type="text/css" href="/frest/app-assets/css/bootstrap-extended.css">
    <link rel="stylesheet" type="text/css" href="/frest/app-assets/css/colors.css">
    <link rel="stylesheet" type="text/css" href="/frest/app-assets/css/components.css">
    <link rel="stylesheet" type="text/css" href="/frest/app-assets/css/themes/dark-layout.css">
    <link rel="stylesheet" type="text/css" href="/frest/app-assets/css/themes/semi-dark-layout.css">
    <!-- END: Theme CSS-->

    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="/frest/app-assets/css/core/menu/menu-types/vertical-menu.css">
    <link rel="stylesheet" type="text/css" href="/frest/app-assets/css/pages/dashboard-analytics.css">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern boxicon-layout no-card-shadow 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        {{-- <li class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="flag-icon flag-icon-us"></i><span class="selected-language">English</span></a>
                            <div class="dropdown-menu" aria-labelledby="dropdown-flag"><a class="dropdown-item" href="#" data-language="en"><i class="flag-icon flag-icon-us mr-50"></i> English</a><a class="dropdown-item" href="#" data-language="id"><i class="flag-icon flag-icon-id mr-50"></i> Bahasa Indonesia</a></div>
                        </li> --}}
                        {{-- <li class="nav-item d-none d-lg-block"><a class="nav-link nav-link-expand"><i class="ficon bx bx-fullscreen"></i></a></li> --}}
                        {{-- <li class="nav-item nav-search"><a class="nav-link nav-link-search"><i class="ficon bx bx-search"></i></a>
                            <div class="search-input">
                                <div class="search-input-icon"><i class="bx bx-search primary"></i></div>
                                <input class="input" type="text" placeholder="Explore Aviat..." tabindex="-1" data-search="template-search">
                                ...
                                <li class="scrollable-container media-list"><a class="d-flex justify-content-between" href="javascript:void(0)">
                                        <div class="media d-flex align-items-center">
                                            <div class="media-left pr-0">
                                                <div class="avatar mr-1 m-0"><img src="/frest/app-assets/images/portrait/small/avatar-s-11.jpg" alt="avatar" height="39" width="39"></div>
                                            </div>
                                    ...
                                    <div class="d-flex justify-content-between read-notification cursor-pointer">
                                        <div class="media d-flex align-items-center">
                                            <div class="media-left pr-0">
                                                <div class="avatar mr-1 m-0"><img src="/frest/app-assets/images/portrait/small/avatar-s-16.jpg" alt="avatar" height="39" width="39"></div>
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <div class="d-flex justify-content-between cursor-pointer">
                                        <div class="media d-flex align-items-center py-0">
                                            <div class="media-left pr-0"><img class="mr-1" src="/frest/app-assets/images/icon/sketch-mac-icon.png" alt="avatar" height="39" width="39"></div>
                                            <div class="media-body">
                                    ...
                                    <div class="d-flex justify-content-between read-notification cursor-pointer">
                                        <div class="media d-flex align-items-center">
                                            <div class="media-left pr-0">
                                                <div class="avatar mr-1 m-0"><img src="/frest/app-assets/images/portrait/small/avatar-s-4.jpg" alt="avatar" height="39" width="39"></div>
                                            </div>
                                            <div class="media-body">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                <div class="user-nav d-sm-flex d-none"><span class="user-name">{{ Auth::user()->email; }}</span><span class="user-status text-muted">Available</span></div><span><img class="round" src="/frest/app-assets/images/portrait/small/avatar-s-11.jpg" alt="avatar" height="40" width="40"></span>
                            </a>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="">
                ...
                <li class=" nav-item"><a href="#"><i class="bx bxs-pencil"></i><span class="menu-title" data-i18n="Blog">Blog</span></a>
                    <ul class="menu-content">
                        <li><a href="#"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Posts">Posts</span></a>
                        </li>
                        <li><a href="#"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Add New">Add New</span></a>
                        </li>
                    </ul>
                </li>
                <li class=" nav-item"><a href="#"><i class="bx bxs-book-content"></i><span class="menu-title" data-i18n="Page">Page</span></a>
                    <ul class="menu-content">
                        <li><a href="#"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Pages">Pages</span></a>
                        </li>
                        <li><a href="#"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Add New">Add New</span></a>
                        </li>
                    </ul>
                ...
                <li class=" nav-item"><a href="#"><i class="bx bx-data"></i><span class="menu-title" data-i18n="Form Data">Form Data</span></a>
                    <ul class="menu-content">
                        <li><a href="/demos"><i class="bx bx-laptop"></i><span class="menu-item" data-i18n="Request Demo">Request Demo</span></a>
                        </li>
                        <li><a href="/compros"><i class="bx bx-building"></i><span class="menu-item" data-i18n="Company Profile">Company Profile</span></a>
                        </li>
                        <li><a href="/contacts"><i class="bx bx-phone"></i><span class="menu-item" data-i18n="Contact Us">Contact Us</span></a>
                        </li>
                        <li><a href="/moduls"><i class="bx bx-show"></i><span class="menu-item" data-i18n="Preview Modul">Preview Modul</span></a>
                        </li>
                        <li><a href="/whatsapps"><i class="bx bxl-whatsapp"></i><span class="menu-item" data-i18n="WhatsApp">WhatsApp</span></a>
                        </li>
                    </ul>
                </li>
                <li class=" nav-item"><a href="#"><i class="bx bx-save"></i><span class="menu-title" data-i18n="File Manager">File Manager</span></a>
                    <ul class="menu-content">
                        <li><a href="#"><i class="bx bx-images"></i><span class="menu-item" data-i18n="Library">Library</span></a>
                        </li>
                        <li><a href="#"><i class="bx bx-upload"></i><span class="menu-item" data-i18n="Add New">Add New</span></a>
                        </li>
                    </ul>
                ...
                <li class=" nav-item"><a href="#"><i class="bx bx-line-chart"></i><span class="menu-title" data-i18n="SEO">SEO</span></a>
                </li>
                <li class=" nav-item"><a href="#"><i class="bx bx-user"></i><span class="menu-title" data-i18n="Users">Users</span></a>
                </li>
                <li class=" nav-item"><a href="#"><i class="bx bx-wrench"></i><span class="menu-title" data-i18n="Settings">Settings</span></a>
                </li>
                <li class=" navigation-header"><span>Support</span>
                </li>
                <li class=" nav-item"><a href="mailto:ijaliffauzi@gmail.com" target="_blank"><i class="bx bx-envelope"></i><span class="menu-title" data-i18n="Contact Developer">Contact Developer</span></a>
                </li>
            </ul>
        </div>
    </div>
                                                    ...
                                                    <div class="widget-todo-title-wrapper d-flex justify-content-between align-items-center mb-50">
                                                        ...
                                                        <div class="widget-todo-item-action d-flex align-items-center">
                                                            ...
                                                            <div class="avatar m-0 mr-50">
                                                                <img src="/frest/app-assets/images/profile/user-uploads/social-2.jpg" alt="img placeholder" height="32" width="32">
                                                            </div>
                                                            <div class="dropdown">
                                                                <span class="bx bx-dots-vertical-rounded font-medium-3 dropdown-toggle nav-hide-arrow cursor-pointer icon-light" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="menu"></span>
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <li class="widget-todo-item">
                                                    <div class="widget-todo-title-wrapper d-flex justify-content-between align-items-center mb-50">
                                                        ...
                                                        <div class="widget-todo-item-action d-flex align-items-center">
                                                            ...
                                                            <div class="avatar m-0 mr-50">
                                                                <img src="/frest/app-assets/images/profile/user-uploads/user-05.jpg" alt="img placeholder" height="32" width="32">
                                                            </div>
                                                            <div class="dropdown">
                                                                <span class="bx bx-dots-vertical-rounded font-medium-3 dropdown-toggle nav-hide-arrow cursor-pointer icon-light" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="menu"></span>
                                                                <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <ul class="widget-timeline mb-0">
                                            <li class="timeline-items timeline-icon-primary active">
                                                ...
                                                <div class="timeline-content">
                                                    <img src="/frest/app-assets/images/icon/pdf.png" alt="document" height="23" width="19" class="mr-50">New Order.pdf
                                                </div>
                                            </li>
                                            <li class="timeline-items timeline-icon-primary active">
                                                ...
                                                <div class="timeline-content">
                                                    <img src="/frest/app-assets/images/icon/pdf.png" alt="document" height="23" width="19" class="mr-50">Invoices.pdf
                                                </div>
                                            </li>
    ...
    <div class="widget-chat-demo">
        ...
        <button class="btn btn-primary chat-demo-button glow px-1"><i class="bx bx-chat" data-options="name: comments.svg; style: lines; size: 24px; strokeColor: #fff; autoPlay: true; repeat: loop;"></i></button>
                    ...
                    <div class="media m-75">
                        <a href="JavaScript:void(0);">
                            <div class="avatar mr-75">
                                <img src="/frest/app-assets/images/portrait/small/avatar-s-2.jpg" alt="avtar images" width="32" height="32">
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-left d-inline-block">Copyright &copy; {{ date('Y') }} <a href="https://kp3.co.id" target="_blank" title="PT Karya Prima Putera Perkasa">PT Karya Prima Putera Perkasa</a></span><span class="float-right d-sm-inline-block d-none">Build with<i class="bx bxs-heart pink mx-50 font-small-3"></i>by<a title="Ijal Fauzi" href="https://www.linkedin.com/in/ijal-fauzi" target="_blank">Jang!</a></span>
    ...
    <script src="/frest/app-assets/fonts/LivIconsEvo/js/LivIconsEvo.tools.js"></script>
    <script src="/frest/app-assets/fonts/LivIconsEvo/js/LivIconsEvo.defaults.js"></script>
    <script src="/frest/app-assets/fonts/LivIconsEvo/js/LivIconsEvo.min.js"></script>
    <!-- BEGIN Vendor JS-->

    <!-- BEGIN: Page Vendor JS-->
    <script src="/frest/app-assets/vendors/js/charts/apexcharts.min.js"></script>
    <script src="/frest/app-assets/vendors/js/extensions/dragula.min.js"></script>
    <!-- END: Page Vendor JS-->

    <!-- BEGIN: Theme JS-->
    <script src="/frest/app-assets/js/core/app-menu.js"></script>
    <script src="/frest/app-assets/js/core/app.js"></script>
    <script src="/frest/app-assets/js/scripts/components.js"></script>
    <script src="/frest/app-assets/js/scripts/footer.js"></script>
    <!-- END: Theme JS-->

    <!-- BEGIN: Page JS-->
    <script src="/frest/app-assets/js/scripts/pages/dashboard-analytics.js"></script>
    <!-- END: Page JS-->
